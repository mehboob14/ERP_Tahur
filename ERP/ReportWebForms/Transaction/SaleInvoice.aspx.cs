...
namespace ERP.ReportWebForms.Transaction
{
    public partial class SaleInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            string PartyDesc = Request.QueryString["PartyDesc"];
            ...
            try
            {
                ...
                if (isValid) // If Report Name provided then do other operation
                {
                    ...
                    rd.Load(Path.Combine(Server.MapPath("~/Reports/Transaction/SaleInvoice.rpt")));
                    ...
                    rd.SetParameterValue("PartyDesc", PartyDesc);
