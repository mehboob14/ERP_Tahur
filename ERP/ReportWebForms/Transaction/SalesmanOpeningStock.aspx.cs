...
{
    public partial class SalesmanOpeningStock : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            string SOSNo = Request.QueryString["SOSCode"];
            try
            {
                bool isValid = true;
                ...
                if (isValid) // If Report Name provided then do other operation
                {
                    ...
                    rd.Load(Path.Combine(Server.MapPath("~/Reports/Transaction/SalesmanOpeningStock.rpt")));
                    rd.SetParameterValue("SOSNo", SOSNo);
