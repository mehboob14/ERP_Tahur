...
namespace ERP.ReportWebForms.Transaction
{
    public partial class DailyDispatch : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            string DispatchCode = Request.QueryString["DispatchCode"];
            try
            {
                bool isValid = true;
                ...
                if (isValid) // If Report Name provided then do other operation
                {
                    ...
                    rd.Load(Path.Combine(Server.MapPath("~/Reports/Transaction/DailyDispatch.rpt")));
                    rd.SetParameterValue("DispatchCode", DispatchCode);
