...
{
    public partial class DailyStockReceive : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            string DSRCode = Request.QueryString["DSRCode"];
            try
            {
                bool isValid = true;
                ...
                if (isValid) // If Report Name provided then do other operation
                {
                    ...
                    rd.Load(Path.Combine(Server.MapPath("~/Reports/Transaction/DailyStockReceive.rpt")));
                    rd.SetParameterValue("DSRCode", DSRCode);
