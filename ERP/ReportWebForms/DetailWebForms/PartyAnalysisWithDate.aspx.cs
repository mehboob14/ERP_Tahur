...
{
    public partial class PartyAnalysisWithDate : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                rd.Load(Path.Combine(Server.MapPath("~/Reports/DetailReports/SalePartiesAnalysisWithDate.rpt")));
