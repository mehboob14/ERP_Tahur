...
{
    public partial class TerminalStockReport : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                rd.Load(Path.Combine(Server.MapPath("~/Reports/DetailReports/TerminalStockReport.rpt")));
                rd.SetParameterValue("@FromDate", FDate);
                rd.SetParameterValue("@ToDate", TDate);
                rd.SetParameterValue("@SOSFromDate", FDate);
                rd.SetParameterValue("@SOSToDate", TDate);
