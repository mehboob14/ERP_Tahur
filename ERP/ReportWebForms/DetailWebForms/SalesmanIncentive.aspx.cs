...
namespace ERP.ReportWebForms.DetailWebForms
{
    public partial class SalesmanIncentive : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                string RegionCode = Request.QueryString["RgionCode"];
                string FromDate = Request.QueryString["FromDate"];
                string ToDate = Request.QueryString["ToDate"];

                DateTime FD = DateTime.ParseExact(FromDate, "dd/MM/yyyy", null);
                DateTime TD = DateTime.ParseExact(ToDate, "dd/MM/yyyy", null);

                

                rd.Load(Path.Combine(Server.MapPath("~/Reports/DetailReports/SalesmanIncentive.rpt")));

                rd.SetParameterValue("@FromDate", FD);
                rd.SetParameterValue("@ToDate", TD);
